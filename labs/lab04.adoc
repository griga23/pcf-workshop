= Lab 4 - Operating your Application
...
. Now let's increase the number of running application instances to 3.  For this lab you can use the Java or Node.js sample app.  In each of the commands below replace _workshop_ with the name of your deployed application:
+
----
$ cf scale -i 3 workshop
Scaling app workshop in org SomeOrg / space somespace as someone@pivotal.io...
OK
----
+
...
----
$ cf app workshop
Showing health and status for app workshop in org SomeOrg / space somespace as someone@pivotal.io...
OK
...
+
How would you do this via the CLI? Hint: cf help or got to http://cli.cloudfoundry.org/en-US/cf/
